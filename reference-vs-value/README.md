...
```js// comparing objects and arrays with === is based on reference
...
```js// using const with arrays and objects is like locking a bag
...
```js// primitives are stored "by value", connected to one variable
